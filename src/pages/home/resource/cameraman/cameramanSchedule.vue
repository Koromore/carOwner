    ...
    <el-drawer title="新建日程" :visible.sync="addSchedule" size="572px">
      <el-row class="addSchedule" v-loading="drawerLoading">
        ...
        <el-col :span="24" class="btn">
          ...
          <el-col :span="8" :offset="3">
            <el-button type="primary" @click="savePhotoSchedule">提交</el-button>
          </el-col>
        </el-col>
      </el-row>
    </el-drawer>
...
export default {
  ...
  data() {
    return {
      ...
      // 日程详情
      preEditSchedule: '',
      carSeriesList: this.$parent.$parent.$parent.carSeriesList,
      carSeriesId: [],
    }
  },
  // 侦听器
  ...
  methods: {
      ...
      this.$axios
        ...
        .then((res) => {
          ...
          if (res.status == 200) {
            ...
            this.photoScheduleListData = data.items
          }
        })
    },
    ///////// 获取预约日程列表 end /////////
    ...
    savePhotoSchedule() {
      ...
      let data = {
        ...
        startTime: this.tiemQuan[0],
        endTime: this.tiemQuan[1],
        during: this.during,
