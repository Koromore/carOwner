      ...
      <el-scrollbar style="height:100%">
        ...
        <el-col :span="12" class="left">
          ...
          <el-col :span="24" class="list">
            ...
            <div class="val">
              <!-- {{photoFileList}} -->
              <!-- <el-image style="width: 100px; height: 100px" :src="item.url" fit="cover" lazy v-for="(item,index) in photoFileList" :key="index"></el-image> -->
              <img v-for="(item,index) in photoFileList" :key="index" :src="item.url" alt srcset />
            </div>
          </el-col>
          <el-col :span="24" class="list">
            ...
            <div class="colon">:</div>
            <div class="val">
              <el-col :span="24" v-for="(item,index) in introduceFileList" :key="index">
                <el-col :span="2" class="icon">
                  <template v-if="$matchType0(item.suffix)=='word'">
                    <svg
                      width="24"
        ...
        <el-col :span="12" class="right">
          <el-col :span="24" class="list">
            ...
            <div class="colon">:</div>
            <div class="val">{{identity}}</div>
          </el-col>
          <el-col :span="24" class="list">
            <div class="key">微信QQ</div>
            <div class="colon">:</div>
            <div class="val">{{qq}}</div>
          </el-col>
          <el-col :span="24" class="list">
