        ...
        <el-col :span="12" class="left">
          ...
          <el-col :span="24" class="list">
            ...
            <div class="val">
              ...
              <el-image style="width: 100px; height: 100px" :src="item.localPath" fit="cover" lazy v-for="(item,index) in photoFileList" :key="index"></el-image>
            </div>
          </el-col>
          <el-col :span="24" class="list">
            <div class="key">自我介绍</div>
            <!-- <div class="val">{{introduceFileList}}</div> -->
            <div class="val" v-for="(item,index) in introduceFileList" :key="index">
              <el-col :span="2" class="icon">
                <template v-if="$matchType0(item.suffix)=='word'">
                  <svg
                    width="24"
