<template>
  <el-dialog title="添加场地" :visible.sync="dialogTableVisible" width="80%">
    <div id="addplace">
      <!-- 内容列表 start -->
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="savePlace">确 定</el-button>
    </div>
  </el-dialog>
</template>
<script>
...
export default {
  ...
  // 侦听器
  watch: {
    addplacetkshow: function (newData, oldData) {
      if (newData) {
